...
MCD12Q1 <- "ftp://e4ftl01.cr.usgs.gov/MOTA/MCD12Q1.051/"
# MCD12Q1a <- "ftp://anonymous:test@e4ftl01u.ecs.nasa.gov/MOLT/MCD12Q1.005/"

# location of the mosiacing tool:
MRT <- '/opt/MRT_Linux/bin/'
workd <- '/home/fcfahl/GIS/02_Data_Sources/02_LULC/03_MODIS/'
...
getlist <- strsplit(getURL(paste(MCD12Q1, dates$dirname[[i]], "/", sep=""), .opts=curlOptions(ftplistonly=TRUE)), "\r\n")[[1]]
BLOCK1 <- getlist[grep(getlist, pattern="MCD12Q1.*.h09v03.*.hdf")[1]]
BLOCK2 <- getlist[grep(getlist, pattern="MCD12Q1.*.h09v04.*.hdf")[1]]
BLOCK3 <- getlist[grep(getlist, pattern="MCD12Q1.*.h10v02.*.hdf")[1]]
BLOCK4 <- getlist[grep(getlist, pattern="MCD12Q1.*.h10v03.*.hdf")[1]]
BLOCK5 <- getlist[grep(getlist, pattern="MCD12Q1.*.h10v04.*.hdf")[1]]
BLOCK6 <- getlist[grep(getlist, pattern="MCD12Q1.*.h11v02.*.hdf")[1]]
BLOCK7 <- getlist[grep(getlist, pattern="MCD12Q1.*.h11v03.*.hdf")[1]]
BLOCK8 <- getlist[grep(getlist, pattern="MCD12Q1.*.h12v03.*.hdf")[1]]
BLOCK9 <- getlist[grep(getlist, pattern="MCD12Q1.*.h12v02.*.hdf")[1]]
...
download.file(paste(MCD12Q1a, dates$dirname[[i]], "/", BLOCK1,sep=""), destfile=paste(getwd(), "/", BLOCK1, sep=""), mode='wb', method='wget', quiet=T, cacheOK=FALSE)
download.file(paste(MCD12Q1, dates$dirname[[i]], "/", BLOCK2,sep=""), destfile=paste(getwd(), "/", BLOCK2,sep=""), mode='wb', method='wget', quiet=T, cacheOK=FALSE)
download.file(paste(MCD12Q1, dates$dirname[[i]], "/", BLOCK3,sep=""), destfile=paste(getwd(), "/", BLOCK3,sep=""), mode='wb', method='wget', quiet=T, cacheOK=FALSE)
download.file(paste(MCD12Q1, dates$dirname[[i]], "/", BLOCK4,sep=""), destfile=paste(getwd(), "/", BLOCK4,sep=""), mode='wb', method='wget', quiet=T, cacheOK=FALSE)
download.file(paste(MCD12Q1, dates$dirname[[i]], "/", BLOCK5,sep=""), destfile=paste(getwd(), "/", BLOCK5,sep=""), mode='wb', method='wget', quiet=T, cacheOK=FALSE)
download.file(paste(MCD12Q1, dates$dirname[[i]], "/", BLOCK6,sep=""), destfile=paste(getwd(), "/", BLOCK6,sep=""), mode='wb', method='wget', quiet=T, cacheOK=FALSE)
download.file(paste(MCD12Q1, dates$dirname[[i]], "/", BLOCK7,sep=""), destfile=paste(getwd(), "/", BLOCK7,sep=""), mode='wb', method='wget', quiet=T, cacheOK=FALSE)
download.file(paste(MCD12Q1, dates$dirname[[i]], "/", BLOCK8,sep=""), destfile=paste(getwd(), "/", BLOCK8,sep=""), mode='wb', method='wget', quiet=T, cacheOK=FALSE)
download.file(paste(MCD12Q1, dates$dirname[[i]], "/", BLOCK9,sep=""), destfile=paste(getwd(), "/", BLOCK9,sep=""), mode='wb', method='wget', quiet=T, cacheOK=FALSE)
