	...
	# Create new table
		SQL_Query1="
			--Creates the target table
				...
				SELECT AddGeometryColumn('${out_Schema}', '${out_Name}','geom', 3035, 'MULTIPOLYGON', 2);
		...
		SQL_Query3="
			INSERT INTO ${out_Table} (cities, item, code, geom)
			SELECT
			  * 
			FROM ${in_Table};
		"
...
export_Parameters
fix_topology "de040l_saarbrucken"  "original" "de040l_geom" "public"
